...
```{r, eval = FALSE}
apikey <- "1AGiPdPVA3YGWexpg193mVrsel41eRoK"
```
...
counts_inequality <-nyt_years_count(q = "inequality", yearinit = 2019, yearend = 2020)
```
...
```{r}
plot(2019:2020, counts_inequality, type = "l", main = "Mentions of inequality in the NYT by year",
